...
// setAssetStateBasedEndorsement 用于为一个新生成的拍卖确认背书组织集合
...
// addAssetStateBasedEndorsement 用于为背书组织集合添加组织
...
// getCollectionName 用于获取提交交易用户的数据集
...
// verifyClientOrgMatchesPeerOrg 用于验证Client的org与peer的org相等
